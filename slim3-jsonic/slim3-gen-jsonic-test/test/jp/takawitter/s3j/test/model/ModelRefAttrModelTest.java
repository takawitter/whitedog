...
public class ModelRefAttrModelTest {
	...
	public void jsonToModel(){
		ModelRefAttrModel model = meta.jsonToModel(
				"{\"expandedRef\":\"aglzbGltMy1nZW5yJQsSEU1vZGVsUmVmQXR0ck1vZGVsIg5leHBhbmRlZCBjaGlsZAw\"," +
				"\"expandedRefList\":[]," +
				"\"key\":\"aglzbGltMy1nZW5yHQsSEU1vZGVsUmVmQXR0ck1vZGVsIgZwYXJlbnQM\"," +
				"\"name\":\"parent\"," +
	...
	public void jsonToModel_1(){
		...
		Assert.assertEquals(
				...
				, KeyFactory.keyToString(model.getExpandedRef().getModel().getExpandedRef().getKey()));
		Assert.assertEquals(
				"aglzbGltMy1nZW5yJQsSEU1vZGVsUmVmQXR0ck1vZGVsIg5leHBhbmRlZCBjaGlsZAw"
				, KeyFactory.keyToString(model.getExpandedRef().getModel().getKey()));
		Assert.assertEquals(
				"expanded child"
				, model.getExpandedRef().getModel().getName());
		Assert.assertEquals(
				"aglzbGltMy1nZW5yHQsSEU1vZGVsUmVmQXR0ck1vZGVsIgZwYXJlbnQM"
				, KeyFactory.keyToString(model.getKey()));
		Assert.assertEquals(
	...
	private ModelRefAttrModel getModel(){
		...
		ModelRefAttrModel gchild = new ModelRefAttrModel("expanded ground child");
		ModelRefAttrModel ggchild = new ModelRefAttrModel("expanded child of expanded ground child");
