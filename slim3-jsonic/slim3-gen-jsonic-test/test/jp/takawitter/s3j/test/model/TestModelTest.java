...
public class TestModelTest {
	...
	public void test(){
		...
		model.setStringListProp(Arrays.asList("hello", "world"));
		...
		model.setStringSetProp(new HashSet<String>(Arrays.asList("hello", "world")));
		...
		model.setStringSortedSetProp(new TreeSet<String>(Arrays.asList("hello", "world")));
...
//		model.setKey(Datastore.createKey(m, 100));
		...
		Assert.assertArrayEquals(
				model.getStringListProp().toArray()
				, model2.getStringListProp().toArray()
				);
		Assert.assertArrayEquals(
		...
		Assert.assertArrayEquals(
				new TreeSet<String>(model.getStringSetProp()).toArray()
				, new TreeSet<String>(model2.getStringSetProp()).toArray()
				);
		Assert.assertArrayEquals(
		...
		Assert.assertArrayEquals(
				new TreeSet<String>(model.getStringSortedSetProp()).toArray()
				, new TreeSet<String>(model2.getStringSortedSetProp()).toArray()
				);
		Assert.assertArrayEquals(
